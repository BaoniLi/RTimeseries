...
for(i in 1:N)
{
  ...
  for(j in 10:(n-10))
  {
    tt=array(dim=n,1)
    tt[1:j]=0
    GA2<-gamlss(test_data~I(tt^1),sigma.formula=~I(t^0),family=GA(mu.link = "identity",sigma.link = "identity"))
    if(SBC>GA2$sbc)
    {
      SBC=GA2$sbc
      type=2
  ...
  for(j in 10:(n-10))
  {
    tt=array(dim=n,1)
    tt[1:j]=0
    GA3<-gamlss(test_data~I(t^0),sigma.formula=~I(tt^1),family=GA(mu.link = "identity",sigma.link = "identity"))
    if(SBC>GA3$sbc)
    {
      SBC=GA3$sbc
      type=3
  ...
  for(j in 10:(n-10))
  {
    tt=array(dim=n,1)
    tt[1:j]=0
    GA4<-gamlss(test_data~I(tt^1),sigma.formula=~I(tt^1),family=GA(mu.link = "identity",sigma.link = "identity"))
    if(SBC>GA4$sbc)
    {
      SBC=GA4$sbc
      type=4
  ...
  #   tt=array(dim=n,1)
  #   tt[1:j]=0
  #   WEI2<-gamlss(test_data~I(tt^1),sigma.formula=~I(t^0),family=WEI(mu.link = "identity",sigma.link = "identity"))
  #   if(SBC>WEI2$sbc)
  #   {
  #     SBC=WEI2$sbc
  #     type=6
  ...
  #   tt=array(dim=n,1)
  #   tt[1:j]=0
  #   WEI3<-gamlss(test_data~I(t^0),sigma.formula=~I(tt^1),family=WEI(mu.link = "identity",sigma.link = "identity"))
  #   if(SBC>WEI3$sbc)
  #   {
  #     SBC=WEI3$sbc
  #     type=7
  ...
  #   tt=array(dim=n,1)
  #   tt[1:j]=0
  #   WEI4<-gamlss(test_data~I(tt^1),sigma.formula=~I(tt^1),family=WEI(mu.link = "identity",sigma.link = "identity"))
  #   if(SBC>WEI4$sbc)
  #   {
  #     SBC=WEI4$sbc
  #     type=8
  ...
  {
    print(GA1)
    p_KS=ks.test(pnorm(GA1$residuals),"punif",0,1)$p.value
    print(p_KS)
  ...
  if(type==2)
  {
    ...
    print(cp)
    print(GA2)
    p_KS=ks.test(pnorm(GA2$residuals),"punif",0,1)$p.value
    print(p_KS)
    
    
    mu=array(dim=n,GA2$mu.coefficients[1]+GA2$mu.coefficients[2]*tt)
  ...
  if(type==3)
  {
    tt=array(dim=n,1)
    tt[1:cp]=0
    GA3<-gamlss(test_data~I(tt^1),sigma.formula=~I(t^0),family=GA(mu.link = "identity",sigma.link = "identity"))
    print(cp)
    print(GA3)
    p_KS=ks.test(pnorm(GA3$residuals),"punif",0,1)$p.value
    print(p_KS)
    
    
    mu=array(dim=n,GA3$mu.coefficients[1]+GA3$mu.coefficients[2]*tt)
  ...
  if(type==4)
  {
    tt=array(dim=n,1)
    tt[1:cp]=0
    GA4<-gamlss(test_data~I(tt^1),sigma.formula=~I(t^0),family=GA(mu.link = "identity",sigma.link = "identity"))
    print(cp)
    print(GA4)
    p_KS=ks.test(pnorm(GA2$residuals),"punif",0,1)$p.value
    print(p_KS)
    ...
    mu=array(dim=n,GA4$mu.coefficients[1]+GA4$mu.coefficients[2]*tt)
  ...
  # {
  #   print(WEI1)
  #   p_KS=ks.test(pnorm(WEI1$residuals),"punif",0,1)$p.value
  #   print(p_KS)
  ...
  #   print(cp)
  #   print(WEI2)
  #   p_KS=ks.test(pnorm(WEI2$residuals),"punif",0,1)$p.value
  #   print(p_KS)
  #   
  #   
  #   mu=array(dim=n,WEI2$mu.coefficients[1]+WEI2$mu.coefficients[2]*tt)
  ...
  #   print(cp)
  #   print(WEI3)
  #   p_KS=ks.test(pnorm(WEI3$residuals),"punif",0,1)$p.value
  #   print(p_KS)
  #   
  #   mu=array(dim=n,WEI3$mu.coefficients[1])
  #   sigma=array(dim=n,WEI3$sigma.coefficients[1]+WEI3$sigma.coefficients[2]*tt)
  #   qQ[,1]=qWEI(0.05,mu,sigma)
  #   qQ[,2]=qWEI(0.25,mu,sigma)
  #   qQ[,3]=qWEI(0.5,mu,sigma)
  #   qQ[,4]=qWEI(0.75,mu,sigma)
  ...
  #   print(cp)
  #   print(WEI4)
  #   p_KS=ks.test(pnorm(WEI4$residuals),"punif",0,1)$p.value
  #   print(p_KS)
  #   
  #   mu=array(dim=n,WEI4$mu.coefficients[1]+WEI4$mu.coefficients[2]*tt)
  #   sigma=array(dim=n,WEI4$sigma.coefficients[1]+WEI4$sigma.coefficients[2]*tt)
  #   qQ[,1]=qWEI(0.05,mu,sigma)
  #   qQ[,2]=qWEI(0.25,mu,sigma)
  #   qQ[,3]=qWEI(0.5,mu,sigma)
  #   qQ[,4]=qWEI(0.75,mu,sigma)
  ...
  output=paste("E:/dissertation/3/QUANTILES_CP/","PET_",data_file[i],sep="")
  write.csv(qQ,output)
...
output=paste("E:/dissertation/3/PET_musigma.csv")
write.csv(musigma,output)
result=rbind(v1,v2,v3,v4)
write.csv(result,"E:/dissertation/3/PET_CP.csv")